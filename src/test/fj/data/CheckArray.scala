...
object CheckArray {
  ...
  val prop_foldRight = property((a: Array[String]) =>
    arrayEqual(stringEqual).eq(
      a.foldRight((a: String, b: Array[String]) => array[String](scala.Array(a)).append(b), empty[String]), a))

  val prop_foldLeft = property((a: Array[String], s: String) =>
    arrayEqual(stringEqual).eq(
      a.foldLeft(((a: Array[String], b: String) => array[String](scala.Array(b)).append(a)), empty[String]),
      a.reverse.foldRight((a: String, b: Array[String]) => array[String](scala.Array(a)).append(b), empty[String])))

  val prop_bindLeftIdentity = property((a: Array[String], s: String) => {
    def f(s: String) = array[String](scala.Array(s.reverse))
    arrayEqual(stringEqual).eq(
      array[String](scala.Array(s)).bind(f(_: String)),
      f(s))})

  val prop_bindRightIdentity = property((a: Array[String]) =>
    arrayEqual(stringEqual).eq(
      a.bind((x: String) => array[String](scala.Array(x))),
      a))

  val prop_bindAssociativity = property((a: Array[String]) => {
    def f(s: String) = array[String](scala.Array(s.reverse))
    def g(s: String) = array[String](scala.Array(s.toUpperCase))
    arrayEqual(stringEqual).eq(
  ...
  val prop_array = property((a: scala.Array[String], n: Int) =>
    (n >= 0 && n < a.length) ==>
    (array[String](a).length == a.length && array[String](a).get(n) == a(n)))
