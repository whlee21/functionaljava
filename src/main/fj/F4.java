 ...
 *          </ul>
 */
public abstract class F4<A, B, C, D, E> implements F<A, F<B, F<C, F<D, E>>>> {
  /**
  ...
  private F4<A, B, C, D, E> self = this;
   ...
   */
  public F3<B, C, D, E> f(final A a) {
    return new F3<B, C, D, E>() {
      public E f(final B b, final C c, final D d) {
