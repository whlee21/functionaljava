...
public final class Class<T> {
  ...
  /**
   * Provides a List of Trees for this class's generic supertypes.
   ...
   */
  public List<Tree<Type>> typeParameterTree() {
    final List<Tree<Type>> t = List.cons(typeParameterTree(c.getGenericSuperclass()), List.<Tree<Type>>nil());
    for (final Type i : c.getGenericInterfaces()) {
      t.snoc(typeParameterTree(i));
    }
    return t;
  }

  private static Tree<Type> typeParameterTree(final Type t) {
